              ...
              <ul class="participants-list">
                ${details.participants.map(email => `
                  <li style="list-style-type: none; display: flex; align-items: center;">
                    <span>${email}</span>
                    <button class="delete-participant" data-activity="${name}" data-email="${email}" title="Unregister" style="background: none; border: none; color: #c62828; margin-left: 8px; cursor: pointer; font-size: 18px;">
                      &#128465;
                    </button>
                  </li>
                `).join("")}
